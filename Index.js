...
`
  ...
  case 'author':
    ...
    capt = `Number : @${number.split('@')[0]}\n`
    capt += 'Instagram : https://www.instagram.com/kakashi_0.3'
    await client.fakeLink(from, capt, thumb, 'Click in here', 'https://www.instagram.com/kakashi_0.3', mek)
...
*OWNER*
- Instagram : https://www.instagram.com/kakashi_0.3
- WhatsApp : wa.me/919389379221

*SCRIPT*
- Git : ${package.homepage}
- License : ${package.license}` 
  client.fakeLink(from, teks, thumb, tanggal, 'https://www.instagram.com/kakashi_0.3', mek)
   break
